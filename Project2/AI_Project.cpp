...
const string testing_image_fn = "mnist/train-images.idx3-ubyte";//"mnist/t10k-images.idx3-ubyte";
const string model_fn = "model-neural-network.dat";
const string testing_label_fn = "mnist/train-labels.idx1-ubyte";//"mnist/t10k-labels.idx1-ubyte";
