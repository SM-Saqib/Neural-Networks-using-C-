...
int main()
{
	...
	for (int sample = 1; sample <= nTraining; ++sample)
	{
		...
		cout << "predict before training  " << predict << "   " << endl;
		...
		while ((iteration < 512))
		{
			...
			SenstivH128(Xi, Wij, 128, sensI, sensH);
			DimInc(imageOut, sensI);

			FilterUpdate(feature3, imageOut, filter4, 28, 28);
			Xupdate(feature3, imageOut, filter4, 28, 28);

			FilterUpdate(feature2, feature3, filter3, 28, 28);
			Xupdate(feature2, feature3, filter3, 28, 28);

			FilterUpdate(feature1, feature2, filter2, 28, 28);
			Xupdate(feature1, feature2, filter2, 28, 28);

			FilterUpdate(imageC, feature1, filter1, 28, 28);
